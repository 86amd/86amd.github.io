...
$(".owl-carousel").owlCarousel({items:1,loop:!0,center:!0,margin:46,nav:!0,navSpeed:500,autoplay:!0,autoplaySpeed:800,autoplayHoverPause:!0,dots:0,navText:["<i class='fa fa-chevron-left'></i>","<i class='fa fa-chevron-right'></i>"],lazyLoad:!0});var owl=$(".owl-carousel");owl.on("mousewheel",".owl-stage",function(e){e.deltaY>0?owl.trigger("prev.owl"):owl.trigger("next.owl"),e.preventDefault()}),owl.on("mousewheel",".owl-nav",function(e){e.deltaY>0?owl.trigger("prev.owl"):owl.trigger("next.owl"),e.preventDefault()});